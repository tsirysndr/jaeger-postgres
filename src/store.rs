...
impl Store {
    ...
    pub async fn migrate(&self) -> Result<()> {
        sqlx::raw_sql(include_str!("../migrations/0001_create_spans.sql"))
            .execute(&self.pool)
            .await
    ...
    fn search_depth(&self, requested: i32) -> u64 {
...
fn attributes_to_json(attributes: &[OtelKeyValue]) -> Value {
    Value::Object(
        attributes
            .iter()
...
fn otel_value_to_json(value: Option<&OtelAnyValue>) -> Value {
